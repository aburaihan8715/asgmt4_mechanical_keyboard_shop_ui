...
const Checkout = () => {
  ...
  return (
    <section className="px-1 py-10 md:py-20">
      ...
      {paymentMethod === 'stripe' && (
        <div className="h-[40vh] flex justify-center items-center">
          <p className="text-3xl font-bold text-center text-transparent text-gray-900 sm:2xl border-primary title-font md:text-4xl bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text">
